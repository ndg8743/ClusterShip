...
\textbf{Tier} & \textbf{Board Size} & \textbf{Creation} & \textbf{Memory} & \textbf{Lookups/sec} & \textbf{Status} \\
\hline
\cellcolor{green!20}Basic & 100 $\times$ 100 & 0.07 ms & 0.01 MB & 1.8M & \textcolor{green!60!black}{PASS} \\
\hline
\cellcolor{blue!20}Standard & 1,000 $\times$ 1,000 & 1.25 ms & 0.21 MB & 7.3M & \textcolor{green!60!black}{PASS} \\
\hline
\cellcolor{orange!20}Advanced & 10,000 $\times$ 10,000 & 14.16 ms & 2.02 MB & 6.3M & \textcolor{green!60!black}{PASS} \\
\hline
\cellcolor{red!20}Extreme & 100,000 $\times$ 100,000 & 81.98 ms & 19.11 MB & 7.7M & \textcolor{green!60!black}{PASS} \\
\hline
\end{tabular}
